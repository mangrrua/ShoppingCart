					...
					<fieldset>
						...
						<div class="form-group">				
							...
							<div class="col-lg-10">													
								...
								<form:input path="customerName" type="text" name="customerName" class="form:input-large"/>
						...
						<div class="form-group">				
							...
							<div class="col-lg-10">													
								...
								<form:input path="cardNumber" type="text" name="cardNumber" class="form:input-large"/>
						...
						<div class="form-group">				
							...
							<div class="col-lg-10">													
								...
								<form:input path="month" type="text" name="month" class="form:input-large"/>
						...
						<div class="form-group">				
							...
							<div class="col-lg-10">													
								...
								<form:input path="year" type="text" name="year" class="form:input-large"/>
						...
						<div class="form-group">				
							...
							<div class="col-lg-10">													
								...
								<form:input path="cvv" type="text" name="cvv" class="form:input-large"/>
						...
						<div class="form-group">										
							<div class="col-lg-10">													
								...
								<input type="submit" value="Payment" class="form:input-large"/>
